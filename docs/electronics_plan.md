...
2. Circuit and firmware verification: settle interfaces, draw the circuit, check electrical behaviour and exercise firmware with controlled inputs. This stage is being planned; a complete online R4 circuit simulation has not run.
